...
However, keep in mind that \textbf{this Unicode support is extremely limited}: many characters are simply unavailable in pdf\LaTeX. For better Unicode support, one should use \XeLaTeX\ or \LuaLaTeX.
